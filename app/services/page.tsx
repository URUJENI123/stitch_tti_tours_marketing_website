      ...
      <section className="py-stack-lg max-w-container-max mx-auto px-gutter">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-stack-md">
          {services.map((svc) => (
            <div
              key={svc.title}
              className="group bg-white p-stack-md rounded-xl premium-shadow premium-shadow-hover transition-all duration-300 text-center flex flex-col items-center"
            >
        ...
        <div className="flex flex-col gap-stack-lg">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-1/2">
              <span className="text-teal font-label-caps uppercase tracking-widest mb-4 block">
                01 / Accommodation
              </span>
              <h2 className="font-headline-lg text-headline-lg text-navy mb-6">
                World-Class Lodging Selection
              </h2>
              ...
              <ul className="space-y-3">
                {['Preferred rates at luxury eco-lodges', 'Verified sanitation and safety standards', '24/7 concierge support during your stay'].map(
                  (item) => (
      ...
      <section className="py-stack-lg bg-surface-container-low">
        <div className="max-w-container-max mx-auto px-gutter text-center">
          <div className="max-w-2xl mx-auto mb-10">
            <span className="font-label-caps text-label-caps uppercase tracking-widest text-teal mb-4 block">
              Reservations
            </span>
            ...
            <p className="font-body-md text-on-surface-variant">
              Contact our travel designers today to craft a bespoke Rwandan experience tailored
              perfectly to your interests and pace.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row justify-center gap-stack-md">
            <Link
              href="/contact"
              className="bg-teal text-white px-10 py-4 rounded-xl font-body-md font-bold premium-shadow hover:bg-teal/90 transition-all"
            >
              Tailor Your Trip
            </Link>
            <Link
              href="/packages"
              className="border-2 border-navy text-navy px-10 py-4 rounded-xl font-body-md font-bold hover:bg-navy hover:text-white transition-all"
            >
              View Packages
            </Link>
          </div>
