      ...
      <section className="py-stack-lg max-w-container-max mx-auto px-gutter">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-stack-lg">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-8 md:p-12 rounded-xl premium-shadow">
          ...
          <div className="lg:col-span-5 space-y-stack-md">
            <div className="bg-surface-container-low p-8 border-l-4 border-teal rounded-xl">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-body-md text-body-md font-bold text-on-surface">
                      Kigali Business Center, 4th Floor<br />KN 5 Rd, Kigali, Rwanda
                    </p>
                  </div>
                </div>
              </div>
              <div className="mt-8 pt-8 border-t border-outline-variant/30">
                ...
                <div className="flex justify-center gap-6">
                  <a href="#" className="text-navy hover:text-teal transition-colors"><span className="material-symbols-outlined">public</span></a>
                  <a href="#" className="text-navy hover:text-teal transition-colors"><span className="material-symbols-outlined">camera</span></a>
                  <a href="#" className="text-navy hover:text-teal transition-colors"><span className="material-symbols-outlined">share</span></a>
                </div>
              </div>
            </div>

            {/* Map Placeholder */}
            <div className="relative h-[300px] bg-surface-container-highest overflow-hidden rounded-xl premium-shadow">
              <div className="absolute inset-0 grayscale opacity-60" style={{
                backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAdSKCmsX7orZB3qv1serd6XV0nwaTv_43_Zy9SfcOZd5o4kmj1aNqjrHD2x8QSyR7BY8-v417rWSufl-gzkZM1xtlmM3fU1Htzg6uEBtxmHSSnwprBWh_8z62R8OdZpR3IKSvO4S0mkhu_8KuvcQTYc2IHgENjUVtCea6agLCOwvnCsJuDgQGBpu2Qlc0b6s02RLAaXuBdKkQv_-Kk0CLKVYqq9Dq0EsZOHqQXlfjHLIRkfNTx8YbWUIFAOM4sxFg0ryO-loSCs8c')",
              }} />
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-2 bg-white px-4 py-1.5 shadow-sm text-sm font-bold text-navy">TTI Tours HQ</div>
                </div>
              </div>
              <div className="absolute bottom-4 left-4 bg-white/90 p-2 text-[10px] font-bold uppercase tracking-tighter text-on-surface-variant">Kigali, Rwanda</div>
            </div>
          </div>
        </div>
      </section>
